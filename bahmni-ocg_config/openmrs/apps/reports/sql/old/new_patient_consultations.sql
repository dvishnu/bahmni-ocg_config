select pat.patient_id,
 ...
 from 
(select distinct a.patient_id patient_id from (select visit_id,patient_id,date_started from visit  where date_started <'#endDate#') a left outer join (select visit_id,patient_id,date_started from visit  where date_started <'#startDate#') b on a.patient_id=b.patient_id where b.visit_id is null  ) pat
join 
